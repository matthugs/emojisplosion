...
# - execute `./download-emoji.sh "paste_the_d_cookie_here" "your_organization_name_as_it_appears_in_the_URL"`
#
...
function download_all_emoji_here() {
    wget -qO- --header "cookie: d=${1}"  "${2}.slack.com/customize/emoji"  | # pull down page html
